 ...
 */
export function getSuccessResults(results) {
  if (!Array.isArray(results)) return [];
 ...
 */
export function getResultSummaryMessage(results, itemType = 'items') {
 ...
 */
export function areAllSuccessful(results) {
 ...
 */
export function hasAnySuccessful(results) {
  if (!Array.isArray(results) || results.length === 0) return false;
 ...
 */
export function getUniqueErrorMessages(results) {
